...
namespace SD3_Graph
{
	public class Form143_ClampTorqStage : Form
	{
		...
		public event CreateForm143_ChooseHandler AlreadyChooseItem;

		public Form143_ClampTorqStage(GlobalVar GB, UIParamStrc UI, int Axis)
		{
			InitializeComponent();
			...
			GetFSParamToMessage();
			ClampTorqTB.KeyPress += EVENT_TG2NDSTAGETORQ_KeyPress;
			ClampTorqTB.LostFocus += EVENT_TG2NDSTAGETORQ_LostFocus;
			toolTip.SetToolTip(ClampTorqTB, GB.UISys.RangeStr + "0.000-" + GB.ToolTorqueWatchUnit().ToString("F3"));
			...
			MaxClampTorqTB.KeyPress += GB.RangeToolTorque_000;
			MaxClampTorqTB.LostFocus += GB.LostFocus_C3;
			toolTip.SetToolTip(MaxClampTorqTB, GB.UISys.RangeStr + "0.000-" + GB.ToolTorqueWatchUnit().ToString("F3"));
			MinClampTorqTB.KeyPress += GB.RangeToolTorque_000;
			MinClampTorqTB.LostFocus += GB.LostFocus_C3;
			toolTip.SetToolTip(MinClampTorqTB, GB.UISys.RangeStr + "0.000-" + GB.ToolTorqueWatchUnit().ToString("F3"));
			...
			GB.CreateUI143 += ShowMarvelIcon;
			GB.CloseOnlyUpdateDelegate(false);
			GB.OnlyUpdateScreenUI143 += GetFSParamToMessage;
		...
		private void ChangeMessageToFSParam()
		{
			if (UI.MouseClickMode == 60)
			{
				...
				{
					double TorqUL = (double)UI.CurrItem.TargetTorque_DW_4 * 2.0;
					double ToolTorqUL = (double)(int)GB.UISys.RunningToolMaxTorqueFW * GB.TorqUnitcoef(2 + GB.UISys.ParamPageAxis) / GB.TorqUnitcoef(1000 + GB.FSModelTypeInfo.MesRawDataTorqUint);
					if (TorqUL >= ToolTorqUL)
					{
						UI.CurrItem.MaxTorque_DW_12 = (uint)ToolTorqUL;
					}
					else
					{
						UI.CurrItem.MaxTorque_DW_12 = (uint)TorqUL;
					}
		...
		public void GetFSParamToMessage()
		{
			...
			MaxClampTorqTB.Text = (GB.Round((double)UI.CurrItem.MaxClampTorque_DW_21 * GB.TorqUnitcoef(2 + GB.UISys.ParamPageAxis), 1) / 1000.0).ToString("F3");
			MinClampTorqTB.Text = (GB.Round((double)UI.CurrItem.MinClampTorque_DW_23 * GB.TorqUnitcoef(2 + GB.UISys.ParamPageAxis), 1) / 1000.0).ToString("F3");
			...
			Torq1stTB.Text = (GB.Round((double)UI.CurrItem.TargetTorque_1st_DW_27 * GB.TorqUnitcoef(2 + GB.UISys.ParamPageAxis), 1) / 1000.0).ToString("F3");
		...
		private void Form143_ClampTorqStage_Load(object sender, EventArgs e)
		{
		}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SD3_Graph.Form143_ClampTorqStage));
			...
			this.gbTightSetStage_AdvancedSetting.Controls.Add(this.groupBox28);
			...
			this.gbTightSetStage_AdvancedSetting.Location = new System.Drawing.Point(335, 48);
			this.gbTightSetStage_AdvancedSetting.Name = "gbTightSetStage_AdvancedSetting";
			this.gbTightSetStage_AdvancedSetting.Size = new System.Drawing.Size(726, 385);
			this.gbTightSetStage_AdvancedSetting.TabIndex = 183;
			...
			this.ShowSWTorqPL.Location = new System.Drawing.Point(4, 304);
			this.ShowSWTorqPL.Name = "ShowSWTorqPL";
			this.ShowSWTorqPL.Size = new System.Drawing.Size(377, 61);
			this.ShowSWTorqPL.TabIndex = 247;
			...
			this.l_MaxSWTorq.Location = new System.Drawing.Point(165, 2);
			...
			this.DccTimeTB.Location = new System.Drawing.Point(168, 275);
			this.DccTimeTB.Name = "DccTimeTB";
			this.DccTimeTB.Size = new System.Drawing.Size(80, 27);
			this.DccTimeTB.TabIndex = 213;
			...
			this.lab_MsUnit4.Location = new System.Drawing.Point(254, 278);
			this.lab_MsUnit4.Name = "lab_MsUnit4";
			this.lab_MsUnit4.Size = new System.Drawing.Size(31, 20);
			this.lab_MsUnit4.TabIndex = 191;
			...
			this.lab_DccTime.Location = new System.Drawing.Point(11, 275);
			this.lab_DccTime.Name = "lab_DccTime";
			this.lab_DccTime.Size = new System.Drawing.Size(150, 27);
			this.lab_DccTime.TabIndex = 189;
			...
			this.lab_SlowStop.Location = new System.Drawing.Point(463, 17);
			this.lab_SlowStop.Name = "lab_SlowStop";
			this.lab_SlowStop.Size = new System.Drawing.Size(154, 27);
			this.lab_SlowStop.TabIndex = 245;
			...
			this.lab_WaitDI7.Location = new System.Drawing.Point(380, 43);
			this.lab_WaitDI7.Name = "lab_WaitDI7";
			this.lab_WaitDI7.Size = new System.Drawing.Size(237, 55);
			this.lab_WaitDI7.TabIndex = 242;
			...
			this.l_MinClampAng.Location = new System.Drawing.Point(169, 220);
			this.l_MinClampAng.Name = "l_MinClampAng";
			this.l_MinClampAng.Size = new System.Drawing.Size(20, 25);
			this.l_MinClampAng.TabIndex = 233;
			...
			this.l_MinClampTorq.Location = new System.Drawing.Point(169, 163);
			this.l_MinClampTorq.Name = "l_MinClampTorq";
			this.l_MinClampTorq.Size = new System.Drawing.Size(20, 25);
			this.l_MinClampTorq.TabIndex = 234;
			...
			this.l_MaxClampTorq.Location = new System.Drawing.Point(169, 134);
			this.l_MaxClampTorq.Name = "l_MaxClampTorq";
			this.l_MaxClampTorq.Size = new System.Drawing.Size(20, 25);
			this.l_MaxClampTorq.TabIndex = 235;
			...
			this.l_MinTime.Location = new System.Drawing.Point(169, 50);
			this.l_MinTime.Name = "l_MinTime";
			this.l_MinTime.Size = new System.Drawing.Size(20, 25);
			this.l_MinTime.TabIndex = 198;
			this.l_MinTime.Text = "!";
			...
			this.TwoStageModeBn.Location = new System.Drawing.Point(630, 205);
			this.TwoStageModeBn.Name = "TwoStageModeBn";
			this.TwoStageModeBn.Size = new System.Drawing.Size(60, 25);
			this.TwoStageModeBn.TabIndex = 232;
			...
			this.l_MaxTime.Location = new System.Drawing.Point(169, 22);
			this.l_MaxTime.Name = "l_MaxTime";
			this.l_MaxTime.Size = new System.Drawing.Size(20, 25);
			this.l_MaxTime.TabIndex = 199;
			this.l_MaxTime.Text = "!";
			...
			this.AccTimeTB.Location = new System.Drawing.Point(168, 247);
			this.AccTimeTB.Name = "AccTimeTB";
			this.AccTimeTB.Size = new System.Drawing.Size(80, 27);
			this.AccTimeTB.TabIndex = 222;
			...
			this.PauseTimeTB.Location = new System.Drawing.Point(168, 105);
			this.PauseTimeTB.Name = "PauseTimeTB";
			this.PauseTimeTB.Size = new System.Drawing.Size(80, 27);
			this.PauseTimeTB.TabIndex = 221;
			...
			this.MaxMinClampAngBn.CheckedChanged += new System.EventHandler(Button_Click);
			...
			this.MaxMinClampTorqBn.CheckedChanged += new System.EventHandler(Button_Click);
			...
			this.MaxMinOperationTimeBn.CheckedChanged += new System.EventHandler(Button_Click);
			...
			this.MinClampAngTB.Location = new System.Drawing.Point(168, 219);
			this.MinClampAngTB.Name = "MinClampAngTB";
			this.MinClampAngTB.Size = new System.Drawing.Size(80, 27);
			this.MinClampAngTB.TabIndex = 218;
			...
			this.MaxClampAngTB.Location = new System.Drawing.Point(168, 191);
			this.MaxClampAngTB.Name = "MaxClampAngTB";
			this.MaxClampAngTB.Size = new System.Drawing.Size(80, 27);
			this.MaxClampAngTB.TabIndex = 217;
			...
			this.HoldTimeTB.Location = new System.Drawing.Point(168, 77);
			this.HoldTimeTB.Name = "HoldTimeTB";
			this.HoldTimeTB.Size = new System.Drawing.Size(80, 27);
			this.HoldTimeTB.TabIndex = 216;
			...
			this.MinClampTorqTB.Location = new System.Drawing.Point(168, 162);
			this.MinClampTorqTB.Name = "MinClampTorqTB";
			this.MinClampTorqTB.Size = new System.Drawing.Size(80, 27);
			this.MinClampTorqTB.TabIndex = 215;
			...
			this.MaxClampTorqTB.Location = new System.Drawing.Point(168, 133);
			this.MaxClampTorqTB.Name = "MaxClampTorqTB";
			this.MaxClampTorqTB.Size = new System.Drawing.Size(80, 27);
			this.MaxClampTorqTB.TabIndex = 214;
			...
			this.lab_Twostagemode.Location = new System.Drawing.Point(485, 208);
			this.lab_Twostagemode.Name = "lab_Twostagemode";
			this.lab_Twostagemode.Size = new System.Drawing.Size(132, 20);
			this.lab_Twostagemode.TabIndex = 210;
			this.lab_Twostagemode.Text = "Two-stage mode";
			this.groupBox28.Controls.Add(this.lab_1stTorque);
			this.groupBox28.Controls.Add(this.Torq1stTB);
			this.groupBox28.Controls.Add(this.Pause1stTB);
			this.groupBox28.Controls.Add(this.lab_TorqUnit6);
			this.groupBox28.Controls.Add(this.AccTime2ndTB);
			this.groupBox28.Controls.Add(this.lab_1stPauseTime);
			this.groupBox28.Controls.Add(this.Speed2ndTB);
			this.groupBox28.Controls.Add(this.lab_MsUnit5);
			this.groupBox28.Controls.Add(this.lab_FinalAccTime);
			this.groupBox28.Controls.Add(this.lab_MsUnit6);
			this.groupBox28.Controls.Add(this.lab_Finalspeed);
			this.groupBox28.Controls.Add(this.lab_SpdUnit2);
			this.groupBox28.Location = new System.Drawing.Point(383, 223);
			this.groupBox28.Name = "groupBox28";
			this.groupBox28.Size = new System.Drawing.Size(343, 124);
			this.groupBox28.TabIndex = 212;
			...
			this.lab_1stTorque.Location = new System.Drawing.Point(-21, 12);
			this.lab_1stTorque.Name = "lab_1stTorque";
			this.lab_1stTorque.Size = new System.Drawing.Size(227, 27);
			...
			this.Torq1stTB.Location = new System.Drawing.Point(208, 12);
			this.Torq1stTB.Name = "Torq1stTB";
			this.Torq1stTB.Size = new System.Drawing.Size(80, 27);
			this.Torq1stTB.TabIndex = 227;
			...
			this.Pause1stTB.Location = new System.Drawing.Point(208, 39);
			this.Pause1stTB.Name = "Pause1stTB";
			this.Pause1stTB.Size = new System.Drawing.Size(80, 27);
			this.Pause1stTB.TabIndex = 228;
			...
			this.lab_TorqUnit6.Location = new System.Drawing.Point(293, 12);
			...
			this.AccTime2ndTB.Location = new System.Drawing.Point(208, 66);
			this.AccTime2ndTB.Name = "AccTime2ndTB";
			this.AccTime2ndTB.Size = new System.Drawing.Size(80, 27);
			this.AccTime2ndTB.TabIndex = 229;
			...
			this.lab_1stPauseTime.Location = new System.Drawing.Point(0, 39);
			this.lab_1stPauseTime.Name = "lab_1stPauseTime";
			this.lab_1stPauseTime.Size = new System.Drawing.Size(206, 27);
			...
			this.Speed2ndTB.Location = new System.Drawing.Point(208, 93);
			this.Speed2ndTB.Name = "Speed2ndTB";
			this.Speed2ndTB.Size = new System.Drawing.Size(80, 27);
			this.Speed2ndTB.TabIndex = 230;
			...
			this.lab_MsUnit5.Location = new System.Drawing.Point(293, 39);
			...
			this.lab_FinalAccTime.Location = new System.Drawing.Point(10, 66);
			this.lab_FinalAccTime.Name = "lab_FinalAccTime";
			this.lab_FinalAccTime.Size = new System.Drawing.Size(196, 27);
			...
			this.lab_MsUnit6.Location = new System.Drawing.Point(293, 66);
			...
			this.lab_Finalspeed.Location = new System.Drawing.Point(40, 93);
			this.lab_Finalspeed.Name = "lab_Finalspeed";
			this.lab_Finalspeed.Size = new System.Drawing.Size(166, 27);
			...
			this.lab_SpdUnit2.Location = new System.Drawing.Point(293, 93);
			...
			this.lab_AngUnit4.Location = new System.Drawing.Point(253, 222);
			this.lab_AngUnit4.Name = "lab_AngUnit4";
			this.lab_AngUnit4.Size = new System.Drawing.Size(14, 20);
			this.lab_AngUnit4.TabIndex = 207;
			...
			this.lab_MinClampAngle.Location = new System.Drawing.Point(11, 219);
			...
			this.lab_AngUnit3.Location = new System.Drawing.Point(253, 194);
			this.lab_AngUnit3.Name = "lab_AngUnit3";
			this.lab_AngUnit3.Size = new System.Drawing.Size(14, 20);
			this.lab_AngUnit3.TabIndex = 204;
			...
			this.lab_MaxClampAngle.Location = new System.Drawing.Point(11, 191);
			this.lab_MaxClampAngle.Name = "lab_MaxClampAngle";
			this.lab_MaxClampAngle.Size = new System.Drawing.Size(150, 27);
			...
			this.lab_TorqUnit5.Location = new System.Drawing.Point(253, 165);
			this.lab_TorqUnit5.Name = "lab_TorqUnit5";
			this.lab_TorqUnit5.Size = new System.Drawing.Size(43, 20);
			this.lab_TorqUnit5.TabIndex = 201;
			...
			this.lab_MinClampTorque.Location = new System.Drawing.Point(-11, 162);
			this.lab_MinClampTorque.Name = "lab_MinClampTorque";
			this.lab_MinClampTorque.Size = new System.Drawing.Size(172, 27);
			...
			this.lab_TorqUnit4.Location = new System.Drawing.Point(253, 136);
			this.lab_TorqUnit4.Name = "lab_TorqUnit4";
			this.lab_TorqUnit4.Size = new System.Drawing.Size(43, 20);
			this.lab_TorqUnit4.TabIndex = 198;
			...
			this.lab_MaxClampTorque.Location = new System.Drawing.Point(0, 133);
			this.lab_MaxClampTorque.Name = "lab_MaxClampTorque";
			this.lab_MaxClampTorque.Size = new System.Drawing.Size(161, 27);
			...
			this.lab_MsUnit2.Location = new System.Drawing.Point(254, 108);
			...
			this.lab_AccTime.Location = new System.Drawing.Point(11, 247);
			...
			this.lab_MsUnit3.Location = new System.Drawing.Point(254, 250);
			this.lab_MsUnit3.Name = "lab_MsUnit3";
			this.lab_MsUnit3.Size = new System.Drawing.Size(31, 20);
			this.lab_MsUnit3.TabIndex = 188;
			...
			this.lab_MsUnit1.Location = new System.Drawing.Point(254, 80);
			...
			this.lab_HoldTime.Location = new System.Drawing.Point(16, 77);
			...
			this.lab_SecUnit2.Location = new System.Drawing.Point(254, 52);
			...
			this.lab_MinOperationTime.Location = new System.Drawing.Point(-7, 49);
			this.lab_MinOperationTime.Name = "lab_MinOperationTime";
			this.lab_MinOperationTime.Size = new System.Drawing.Size(173, 27);
			...
			this.lab_SecUnit1.Location = new System.Drawing.Point(254, 24);
			...
			this.lab_MaxOperationTime.Location = new System.Drawing.Point(-4, 21);
			this.lab_MaxOperationTime.Name = "lab_MaxOperationTime";
			this.lab_MaxOperationTime.Size = new System.Drawing.Size(170, 27);
			...
			this.gbTightSetStage_Target.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			this.gbTightSetStage_Target.Location = new System.Drawing.Point(4, 47);
			this.gbTightSetStage_Target.Name = "gbTightSetStage_Target";
			this.gbTightSetStage_Target.Size = new System.Drawing.Size(333, 129);
			this.gbTightSetStage_Target.TabIndex = 181;
			...
			this.l_ClampTorq.Location = new System.Drawing.Point(127, 21);
			this.l_ClampTorq.Name = "l_ClampTorq";
			this.l_ClampTorq.Size = new System.Drawing.Size(20, 25);
			this.l_ClampTorq.TabIndex = 241;
			...
			this.ClampTorqTB.Location = new System.Drawing.Point(125, 20);
			this.ClampTorqTB.Name = "ClampTorqTB";
			this.ClampTorqTB.Size = new System.Drawing.Size(80, 27);
			this.ClampTorqTB.TabIndex = 102;
			...
			this.lab_SpdUnit1.Location = new System.Drawing.Point(213, 52);
			...
			this.lab_TorqUnit1.Location = new System.Drawing.Point(213, 23);
			...
			this.lab_Speed.Location = new System.Drawing.Point(2, 49);
			...
			this.lab_ClampTorq.Location = new System.Drawing.Point(2, 20);
			this.lab_ClampTorq.Name = "lab_ClampTorq";
			this.lab_ClampTorq.Size = new System.Drawing.Size(120, 27);
			this.lab_ClampTorq.TabIndex = 101;
			...
			this.gbTightSetStage_Limits.Location = new System.Drawing.Point(4, 196);
			this.gbTightSetStage_Limits.Name = "gbTightSetStage_Limits";
			this.gbTightSetStage_Limits.Size = new System.Drawing.Size(333, 175);
			this.gbTightSetStage_Limits.TabIndex = 182;
			...
			this.l_MinTorq.Location = new System.Drawing.Point(127, 47);
			this.l_MinTorq.Name = "l_MinTorq";
			this.l_MinTorq.Size = new System.Drawing.Size(20, 25);
			this.l_MinTorq.TabIndex = 196;
			this.l_MinTorq.Text = "!";
			...
			this.l_MaxTorq.Location = new System.Drawing.Point(127, 19);
			this.l_MaxTorq.Name = "l_MaxTorq";
			this.l_MaxTorq.Size = new System.Drawing.Size(20, 25);
			this.l_MaxTorq.TabIndex = 197;
			this.l_MaxTorq.Text = "!";
			...
			this.l_MinAng.Location = new System.Drawing.Point(127, 103);
			this.l_MinAng.Name = "l_MinAng";
			this.l_MinAng.Size = new System.Drawing.Size(20, 25);
			this.l_MinAng.TabIndex = 194;
			this.l_MinAng.Text = "!";
			...
			this.MaxAngTB.Location = new System.Drawing.Point(125, 74);
			this.MaxAngTB.Name = "MaxAngTB";
			this.MaxAngTB.Size = new System.Drawing.Size(80, 27);
			this.MaxAngTB.TabIndex = 140;
			...
			this.MinTorqTB.Location = new System.Drawing.Point(125, 46);
			this.MinTorqTB.Name = "MinTorqTB";
			this.MinTorqTB.Size = new System.Drawing.Size(80, 27);
			this.MinTorqTB.TabIndex = 138;
			...
			this.MaxTorqTB.Location = new System.Drawing.Point(125, 18);
			this.MaxTorqTB.Name = "MaxTorqTB";
			this.MaxTorqTB.Size = new System.Drawing.Size(80, 27);
			this.MaxTorqTB.TabIndex = 137;
			...
			this.lab_AngUnit2.Location = new System.Drawing.Point(213, 105);
			...
			this.lab_AngUnit1.Location = new System.Drawing.Point(213, 77);
			...
			this.lab_MinAngle.Location = new System.Drawing.Point(2, 102);
			...
			this.lab_MaxAngle.Location = new System.Drawing.Point(2, 74);
			...
			this.lab_TorqUnit3.Location = new System.Drawing.Point(213, 49);
			...
			this.lab_TorqUnit2.Location = new System.Drawing.Point(213, 21);
			...
			this.lab_MinTorque.Location = new System.Drawing.Point(2, 46);
			...
			this.lab_MaxTorque.Location = new System.Drawing.Point(2, 18);
			...
			base.Name = "Form143_ClampTorqStage";
			base.Load += new System.EventHandler(Form143_ClampTorqStage_Load);
