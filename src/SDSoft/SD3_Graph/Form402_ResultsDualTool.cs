...
namespace SD3_Graph
{
	public class Form402_ResultsDualTool : Form
	{
		...
		private Label labGuide_Status2;

		private Label labGuide_Status1;
		...
		public event CreateForm402_JumpPageHandler CreateJumpPageEvent;

		public Form402_ResultsDualTool(GlobalVar GB, TCPclient TCP, TransferCSV TrCSV)
		{
			InitializeComponent();
		...
		private void Form402_ResultsDualTool_Load(object sender, EventArgs e)
		{
		...
		private unsafe void UpdataScreen(int Axis)
		{
			...
			if (Axis == 0)
			{
				Label label = labGuide_Status1;
				bool visible = (lab_Status1.Visible = ((GB.TcpStatus.Detail.T1StB.Ready_18 == 0 && GB.TcpStatus.Detail.T1StB.TighteningResultOKNOKAutoClearNextRun_29 == 1) ? true : false));
			...
			{
				Label label19 = labGuide_Status2;
				bool visible = (lab_Status2.Visible = ((GB.TcpStatus.Detail.T2StB.Ready_18 == 0 && GB.TcpStatus.Detail.T2StB.TighteningResultOKNOKAutoClearNextRun_29 == 1) ? true : false));
				...
				text = (lab_PrevailTorq2.Text = MultiLanguage.GetStr("Form400_Results", "lab_PrevailTorq") + " " + ((float)(GB.TcpStatus.Detail.T2StB.PrevailTorque_H_11 * 65536 + GB.TcpStatus.Detail.T2StB.PrevailTorque_L_10) / 1000f).ToString("F3") + " " + MultiLanguage.GetStr("Form500_Controller", "tp_TorqUnit" + GB.UISys.RunningSrcY.TorqueUnit));
				label34.Text = text;
				if (GB.FSCtrlAngleUnit.Mode == 0)
				{
		...
		private void Form402_ResultsDualTool_FormClosing(object sender, FormClosingEventArgs e)
		{
			Form_closed();
		}
		...
		private void Form402_ResultsDualTool_FormClosed(object sender, FormClosedEventArgs e)
		{
			Form_closed();
		}
		...
		public void ParmCheckTighteningStage(int Axis)
		{
			...
			if (Axis == 0)
			{
				...
				bool visible = (TargetBn.Visible = ((TargetTorqueMode != 0) ? true : false));
				targetGuideBn.Visible = visible;
			}
			else
			{
				Button targetGuideBn2 = TargetGuideBn2;
				bool visible = (TargetBn2.Visible = ((TargetTorqueMode != 0) ? true : false));
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SD3_Graph.Form402_ResultsDualTool));
			...
			this.labGuide_Status2 = new System.Windows.Forms.Label();
			this.labGuide_Status1 = new System.Windows.Forms.Label();
			...
			chartArea5.InnerPlotPosition.Height = 87f;
			chartArea5.InnerPlotPosition.Width = 80f;
			chartArea5.InnerPlotPosition.X = 10f;
			chartArea5.InnerPlotPosition.Y = 3f;
			...
			chartArea6.AxisX2.LineColor = System.Drawing.Color.LightGray;
			chartArea6.AxisY.LineColor = System.Drawing.Color.LightGray;
			chartArea6.AxisY2.LineColor = System.Drawing.Color.LightGray;
			chartArea6.InnerPlotPosition.Auto = false;
			chartArea6.InnerPlotPosition.Height = 87f;
			chartArea6.InnerPlotPosition.Width = 80f;
			chartArea6.InnerPlotPosition.X = 10f;
			chartArea6.InnerPlotPosition.Y = 3f;
			...
			resources.ApplyResources(this.LEDPanel2, "LEDPanel2");
			this.LEDPanel2.Name = "LEDPanel2";
			resources.ApplyResources(this.lab_ParamProcess2, "lab_ParamProcess2");
			this.lab_ParamProcess2.Name = "lab_ParamProcess2";
			resources.ApplyResources(this.lab_SeqProcess2, "lab_SeqProcess2");
			...
			resources.ApplyResources(this.dataGridView_ParamProcessLED2, "dataGridView_ParamProcessLED2");
			...
			resources.ApplyResources(this.dataGridView_SeqProcessLED2, "dataGridView_SeqProcessLED2");
			...
			this.lab_Status1.BackColor = System.Drawing.Color.Transparent;
			resources.ApplyResources(this.lab_Status1, "lab_Status1");
			this.lab_Status1.ForeColor = System.Drawing.Color.Blue;
			this.lab_Status1.Name = "lab_Status1";
			this.lab_Status2.BackColor = System.Drawing.Color.Transparent;
			resources.ApplyResources(this.lab_Status2, "lab_Status2");
			this.lab_Status2.ForeColor = System.Drawing.Color.Blue;
			...
			this.ShowGuidePL1.Controls.Add(this.labGuide_Status2);
			this.ShowGuidePL1.Controls.Add(this.labGuide_Status1);
			...
			this.labGuide_Status2.BackColor = System.Drawing.Color.Transparent;
			resources.ApplyResources(this.labGuide_Status2, "labGuide_Status2");
			this.labGuide_Status2.ForeColor = System.Drawing.Color.Blue;
			this.labGuide_Status2.Name = "labGuide_Status2";
			this.labGuide_Status1.BackColor = System.Drawing.Color.Transparent;
			resources.ApplyResources(this.labGuide_Status1, "labGuide_Status1");
			this.labGuide_Status1.ForeColor = System.Drawing.Color.Blue;
			this.labGuide_Status1.Name = "labGuide_Status1";
			...
			base.Controls.Add(this.lab_Status2);
			base.Controls.Add(this.lab_Status1);
			...
			base.Controls.Add(this.LEDPanel2);
			...
			base.Name = "Form402_ResultsDualTool";
			base.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			base.FormClosing += new System.Windows.Forms.FormClosingEventHandler(Form402_ResultsDualTool_FormClosing);
			base.FormClosed += new System.Windows.Forms.FormClosedEventHandler(Form402_ResultsDualTool_FormClosed);
			base.Load += new System.EventHandler(Form402_ResultsDualTool_Load);
