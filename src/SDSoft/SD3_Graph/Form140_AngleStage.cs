...
namespace SD3_Graph
{
	public class Form140_AngleStage : Form
	{
		...
		private TextBox AngleForPrevailTorqTB;

		private Label lab_PercentUnit1;

		private Label lab_AngleRangeforPrevailTorqueCalc;
		...
		public event CreateForm140_ChooseHandler AlreadyChooseItem;

		public Form140_AngleStage(GlobalVar GB, UIParamStrc UI, int Axis)
		{
			InitializeComponent();
			...
			lab_AngleRangeforPrevailTorqueCalc.Visible = (AngleForPrevailTorqTB.Visible = (lab_PercentUnit1.Visible = true));
			...
			AngleForPrevailTorqTB.KeyPress += EVENT_PREVAILTORQSET_KeyPress;
			AngleForPrevailTorqTB.LostFocus += EVENT_PREVAILTORQSET_LostFocus;
			toolTip.SetToolTip(AngleForPrevailTorqTB, GB.UISys.RangeStr + "0-100");
			...
			GB.CreateUI140 += ShowMarvelIcon;
			GB.CloseOnlyUpdateDelegate(false);
			GB.OnlyUpdateScreenUI140 += GetFSParamToMessage;
		...
		private void ShowTorqUnitText()
		{
			...
			Label label5 = lab_AngUnit2;
			text3 = (lab_AngUnit3.Text = AngStr);
			text5 = (label5.Text = text3);
			label4.Text = text5;
		}

		public void EVENT_PREVAILTORQSET_KeyPress(object sender, KeyPressEventArgs e)
		{
			UI.MouseClickMode = 23;
			GB.RangeUnsigned100(sender, e);
		}

		public void EVENT_PREVAILTORQSET_LostFocus(object sender, EventArgs e)
		{
			UI.MouseClickMode = 23;
		...
		{
			if (UI.MouseClickMode == 23)
			{
				bool AllPrevailTorqueLinkSwitch = false;
				for (int i = 0; i < 6; i++)
				{
					if (UI.CurrWAItem[i].AngleRangeForPrevailTorqueCalc_19 > 0)
					{
		...
		public void GetFSParamToMessage()
		{
			...
			AngleForPrevailTorqTB.Text = UI.CurrItem.AngleRangeForPrevailTorqueCalc_19.ToString();
		...
		public void SetMessageToFSParam()
		{
			...
			UI.CurrItem.AngleRangeForPrevailTorqueCalc_19 = ushort.Parse(AngleForPrevailTorqTB.Text);
		...
		private void Form140_AngleStage_Load(object sender, EventArgs e)
		{
		}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SD3_Graph.Form140_AngleStage));
			...
			this.AngleForPrevailTorqTB = new System.Windows.Forms.TextBox();
			this.lab_PercentUnit1 = new System.Windows.Forms.Label();
			this.lab_AngleRangeforPrevailTorqueCalc = new System.Windows.Forms.Label();
			...
			this.gbTightSetStage_AdvancedSetting.Controls.Add(this.AngleForPrevailTorqTB);
			this.gbTightSetStage_AdvancedSetting.Controls.Add(this.lab_PercentUnit1);
			this.gbTightSetStage_AdvancedSetting.Controls.Add(this.lab_AngleRangeforPrevailTorqueCalc);
			...
			this.gbTightSetStage_AdvancedSetting.Location = new System.Drawing.Point(354, 73);
			this.gbTightSetStage_AdvancedSetting.Name = "gbTightSetStage_AdvancedSetting";
			this.gbTightSetStage_AdvancedSetting.Size = new System.Drawing.Size(701, 355);
			this.gbTightSetStage_AdvancedSetting.TabIndex = 144;
			...
			this.ShowSWTorqPL.Location = new System.Drawing.Point(2, 203);
			this.ShowSWTorqPL.Name = "ShowSWTorqPL";
			this.ShowSWTorqPL.Size = new System.Drawing.Size(382, 70);
			this.ShowSWTorqPL.TabIndex = 270;
			...
			this.l_MaxSWTorq.Location = new System.Drawing.Point(172, 8);
			...
			this.lab_TorqUnit8.Location = new System.Drawing.Point(258, 39);
			this.lab_TorqUnit8.Name = "lab_TorqUnit8";
			this.lab_TorqUnit8.Size = new System.Drawing.Size(43, 20);
			this.lab_TorqUnit8.TabIndex = 240;
			...
			this.lab_TorqUnit7.Location = new System.Drawing.Point(258, 10);
			this.lab_TorqUnit7.Name = "lab_TorqUnit7";
			this.lab_TorqUnit7.Size = new System.Drawing.Size(43, 20);
			this.lab_TorqUnit7.TabIndex = 241;
			...
			this.SlowStopBn.Location = new System.Drawing.Point(623, 17);
			this.SlowStopBn.Name = "SlowStopBn";
			this.SlowStopBn.Size = new System.Drawing.Size(60, 25);
			this.SlowStopBn.TabIndex = 226;
			...
			this.lab_SlowStop.Location = new System.Drawing.Point(484, 19);
			this.lab_SlowStop.Name = "lab_SlowStop";
			this.lab_SlowStop.Size = new System.Drawing.Size(130, 20);
			this.lab_SlowStop.TabIndex = 225;
			...
			this.DccTimeTB.Location = new System.Drawing.Point(173, 139);
			this.DccTimeTB.Name = "DccTimeTB";
			this.DccTimeTB.Size = new System.Drawing.Size(80, 27);
			this.DccTimeTB.TabIndex = 223;
			...
			this.WaitDI7Bn.Location = new System.Drawing.Point(623, 58);
			this.WaitDI7Bn.Name = "WaitDI7Bn";
			this.WaitDI7Bn.Size = new System.Drawing.Size(60, 25);
			this.WaitDI7Bn.TabIndex = 223;
			...
			this.lab_MsUnit3.Location = new System.Drawing.Point(261, 142);
			this.lab_MsUnit3.Name = "lab_MsUnit3";
			this.lab_MsUnit3.Size = new System.Drawing.Size(31, 20);
			this.lab_MsUnit3.TabIndex = 224;
			...
			this.lab_WaitDI7.Location = new System.Drawing.Point(381, 43);
			this.lab_WaitDI7.Name = "lab_WaitDI7";
			this.lab_WaitDI7.Size = new System.Drawing.Size(237, 55);
			this.lab_WaitDI7.TabIndex = 221;
			...
			this.lab_DccTime.Location = new System.Drawing.Point(2, 139);
			this.lab_DccTime.Name = "lab_DccTime";
			this.lab_DccTime.Size = new System.Drawing.Size(167, 27);
			this.lab_DccTime.TabIndex = 222;
			...
			this.lab_MsUnit1.Location = new System.Drawing.Point(261, 86);
			...
			this.AngleForPrevailTorqTB.Font = new System.Drawing.Font("新細明體", 10f);
			this.AngleForPrevailTorqTB.Location = new System.Drawing.Point(173, 173);
			this.AngleForPrevailTorqTB.Name = "AngleForPrevailTorqTB";
			this.AngleForPrevailTorqTB.Size = new System.Drawing.Size(80, 27);
			this.AngleForPrevailTorqTB.TabIndex = 153;
			this.AngleForPrevailTorqTB.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.lab_PercentUnit1.AutoSize = true;
			this.lab_PercentUnit1.Font = new System.Drawing.Font("新細明體", 12f);
			this.lab_PercentUnit1.ImeMode = System.Windows.Forms.ImeMode.NoControl;
			this.lab_PercentUnit1.Location = new System.Drawing.Point(261, 176);
			this.lab_PercentUnit1.Name = "lab_PercentUnit1";
			this.lab_PercentUnit1.Size = new System.Drawing.Size(25, 20);
			this.lab_PercentUnit1.TabIndex = 154;
			this.lab_PercentUnit1.Text = "%";
			this.lab_AngleRangeforPrevailTorqueCalc.Font = new System.Drawing.Font("新細明體", 12f);
			this.lab_AngleRangeforPrevailTorqueCalc.ImeMode = System.Windows.Forms.ImeMode.NoControl;
			this.lab_AngleRangeforPrevailTorqueCalc.Location = new System.Drawing.Point(-4, 164);
			this.lab_AngleRangeforPrevailTorqueCalc.Name = "lab_AngleRangeforPrevailTorqueCalc";
			this.lab_AngleRangeforPrevailTorqueCalc.Size = new System.Drawing.Size(171, 44);
			this.lab_AngleRangeforPrevailTorqueCalc.TabIndex = 152;
			this.lab_AngleRangeforPrevailTorqueCalc.Text = "Angle Range for Prevail Torque Calc";
			this.lab_AngleRangeforPrevailTorqueCalc.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.AccTimeTB.Font = new System.Drawing.Font("新細明體", 10f);
			this.AccTimeTB.Location = new System.Drawing.Point(173, 111);
			...
			this.l_MinTime.Location = new System.Drawing.Point(175, 55);
			this.l_MinTime.Name = "l_MinTime";
			this.l_MinTime.Size = new System.Drawing.Size(20, 25);
			this.l_MinTime.TabIndex = 161;
			this.l_MinTime.Text = "!";
			...
			this.PauseTimeTB.Location = new System.Drawing.Point(173, 83);
			this.PauseTimeTB.Name = "PauseTimeTB";
			this.PauseTimeTB.Size = new System.Drawing.Size(80, 27);
			this.PauseTimeTB.TabIndex = 146;
			...
			this.l_MaxTime.Location = new System.Drawing.Point(175, 26);
			this.l_MaxTime.Name = "l_MaxTime";
			this.l_MaxTime.Size = new System.Drawing.Size(20, 25);
			this.l_MaxTime.TabIndex = 164;
			this.l_MaxTime.Text = "!";
			...
			this.MinOperationTimeTB.Location = new System.Drawing.Point(173, 54);
			...
			this.MaxOperationTimeTB.Location = new System.Drawing.Point(173, 25);
			...
			this.MaxMinOperationTimeBn.Location = new System.Drawing.Point(317, 40);
			...
			this.lab_MsUnit2.Location = new System.Drawing.Point(261, 114);
			...
			this.lab_AccTime.Location = new System.Drawing.Point(0, 111);
			this.lab_AccTime.Name = "lab_AccTime";
			this.lab_AccTime.Size = new System.Drawing.Size(167, 27);
			...
			this.lab_PauseTime.Location = new System.Drawing.Point(0, 83);
			this.lab_PauseTime.Name = "lab_PauseTime";
			this.lab_PauseTime.Size = new System.Drawing.Size(167, 27);
			...
			this.lab_SecUnit2.Location = new System.Drawing.Point(261, 57);
			...
			this.lab_MinOperationTime.Location = new System.Drawing.Point(0, 54);
			...
			this.lab_SecUnit1.Location = new System.Drawing.Point(261, 28);
			...
			this.lab_MaxOperationTime.Location = new System.Drawing.Point(0, 25);
			...
			this.gbTightSetStage_Limits.Location = new System.Drawing.Point(7, 226);
			this.gbTightSetStage_Limits.Name = "gbTightSetStage_Limits";
			this.gbTightSetStage_Limits.Size = new System.Drawing.Size(342, 141);
			this.gbTightSetStage_Limits.TabIndex = 143;
			...
			this.l_MinAng.Location = new System.Drawing.Point(144, 106);
			...
			this.l_MinTorq.Location = new System.Drawing.Point(144, 48);
			this.l_MinTorq.Name = "l_MinTorq";
			this.l_MinTorq.Size = new System.Drawing.Size(20, 25);
			this.l_MinTorq.TabIndex = 160;
			this.l_MinTorq.Text = "!";
			...
			this.l_MaxAng.Location = new System.Drawing.Point(144, 77);
			this.l_MaxAng.Name = "l_MaxAng";
			this.l_MaxAng.Size = new System.Drawing.Size(20, 25);
			this.l_MaxAng.TabIndex = 162;
			this.l_MaxAng.Text = "!";
			...
			this.MaxAngTB.Location = new System.Drawing.Point(142, 76);
			...
			this.MinTorqTB.Location = new System.Drawing.Point(142, 47);
			...
			this.MaxMinAngBn.Location = new System.Drawing.Point(277, 83);
			...
			this.lab_AngUnit3.Location = new System.Drawing.Point(224, 108);
			...
			this.lab_AngUnit2.Location = new System.Drawing.Point(224, 79);
			...
			this.lab_MinAngle.Location = new System.Drawing.Point(36, 105);
			...
			this.lab_MaxAngle.Location = new System.Drawing.Point(36, 76);
			...
			this.MaxMinTorqBn.Location = new System.Drawing.Point(277, 37);
			...
			this.lab_TorqUnit2.Location = new System.Drawing.Point(224, 50);
			...
			this.lab_TorqUnit1.Location = new System.Drawing.Point(224, 21);
			...
			this.gbTightSetStage_Target.Location = new System.Drawing.Point(7, 72);
			this.gbTightSetStage_Target.Name = "gbTightSetStage_Target";
			this.gbTightSetStage_Target.Size = new System.Drawing.Size(342, 129);
			this.gbTightSetStage_Target.TabIndex = 142;
			...
			this.l_Spd.Location = new System.Drawing.Point(144, 51);
			this.l_Spd.Name = "l_Spd";
			this.l_Spd.Size = new System.Drawing.Size(20, 25);
			this.l_Spd.TabIndex = 165;
			this.l_Spd.Text = "!";
			...
			this.AngleTB.Location = new System.Drawing.Point(142, 20);
			...
			this.lab_SpdUnit1.Location = new System.Drawing.Point(224, 53);
			...
			this.lab_AngUnit1.Location = new System.Drawing.Point(224, 23);
			...
			this.lab_Speed.Location = new System.Drawing.Point(36, 50);
			...
			this.lab_Angle.Location = new System.Drawing.Point(36, 20);
			this.lab_Angle.Name = "lab_Angle";
			this.lab_Angle.Size = new System.Drawing.Size(100, 27);
			...
			this.lab_Direction.TabIndex = 145;
			...
			base.Name = "Form140_AngleStage";
			base.Load += new System.EventHandler(Form140_AngleStage_Load);
