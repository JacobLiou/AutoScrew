...
public partial class DeviceProductionHistoryPage : INavigableView<DeviceProductionHistoryViewModel>
{
    private bool _initialized;

    public DeviceProductionHistoryViewModel ViewModel { get; }

    public DeviceProductionHistoryPage(DeviceProductionHistoryViewModel viewModel)
    {
        ViewModel = viewModel;
        DataContext = this;
        InitializeComponent();
