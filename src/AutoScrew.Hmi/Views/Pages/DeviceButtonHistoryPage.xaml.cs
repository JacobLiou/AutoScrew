...
public partial class DeviceButtonHistoryPage : INavigableView<DeviceButtonHistoryViewModel>
{
    private bool _initialized;

    public DeviceButtonHistoryViewModel ViewModel { get; }

    public DeviceButtonHistoryPage(DeviceButtonHistoryViewModel viewModel)
    {
        ViewModel = viewModel;
        DataContext = this;
        InitializeComponent();
